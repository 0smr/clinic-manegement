...
\pagebreak
	...
	تخمین زمان به وسیله نمودار گانت مشخص شده و به موازات آن در جدول زمانی مشخص شده است.
	
	تخمین کل زمان برای پروژه تا فاز استقرار معادل 77 روز بوده‌است.
	که جدا از فاز نگهداری مشخص شده است.
	...
	\begin{figure}[!h]
		...
		\begin{subfigure}[t]{0.3\linewidth}
			\frame{\includegraphics[width=0.9\textwidth]{UI/Desktop_UI_1.png}}
			\caption{
				صفحه ورود}
		\end{subfigure}\hfill%
		\begin{subfigure}[t]{0.3\linewidth}
			\frame{\includegraphics[width=0.9\textwidth]{UI/Desktop_UI_2.PNG}}
			\caption{
				صفحه اصلی}
		\end{subfigure}\hfill%
		\begin{subfigure}[t]{0.3\linewidth}
			\frame{\includegraphics[width=0.9\textwidth]{UI/Desktop_UI_3.PNG}}
			\caption{
				افزودن کارمند}
		\end{subfigure}

		\begin{subfigure}[t]{0.3\linewidth}
			\frame{\includegraphics[width=0.9\textwidth]{UI/Desktop_UI_4.png}}
			\caption{
				افزودن بیمه}
		\end{subfigure}\hfill%
		\begin{subfigure}[t]{0.3\linewidth}
			\frame{\includegraphics[width=0.9\textwidth]{UI/Desktop_UI_5.PNG}}
			\caption{
				افزودن بیمار}
		\end{subfigure}\hfill%
		\begin{subfigure}[t]{0.3\linewidth}
			\frame{\includegraphics[width=0.9\textwidth]{UI/Desktop_UI_6.PNG}}
			\caption{
				افزودن سریع بیمار}
		\end{subfigure}

		\begin{subfigure}[t]{0.6\linewidth}
			\frame{\includegraphics[width=0.9\textwidth]{UI/Desktop_UI_7.PNG}}
			\caption{
				افزودن بیمار}
		\end{subfigure}
		\normalsize
	...
	\begin{figure}[!h]
		...
		\begin{subfigure}[t]{0.47\linewidth}
			\frame{\includegraphics[width=\textwidth]{UI/Website_UI_1.png}}
			\caption{
				صفحه ورود}
		\end{subfigure}\hfill%
		\begin{subfigure}[t]{0.47\linewidth}
			\frame{\includegraphics[width=\textwidth]{UI/Website_UI_2.PNG}}
			\caption{
				صفحه اصلی}
		\end{subfigure}
	
		\begin{subfigure}[t]{0.47\linewidth}
			\frame{\includegraphics[width=\textwidth]{UI/Website_UI_3.PNG}}
			\caption{
				درباره ‌ما}
		\end{subfigure}\hfill%
		\begin{subfigure}[t]{0.47\linewidth}
			\frame{\includegraphics[width=\textwidth]{UI/Website_UI_4.png}}
			\caption{
				تماس با ما}
		\end{subfigure}
	
		\begin{subfigure}[t]{0.75\linewidth}
			\frame{\includegraphics[width=\textwidth]{UI/Website_UI_5.PNG}}
			\caption{
				لیست دکتر‌ها}
		\end{subfigure}
		\normalsize
